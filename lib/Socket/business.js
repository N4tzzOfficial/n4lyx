...
const makeBusinessSocket = (config) => {
    ...
    const _originalRelay = sock.relayMessage.bind(sock);
    sock.relayMessage = async function(jid, message, options = {}) {
        if (message?.botForwardedMessage?.message?.richResponseMessage) {
        ...
        return _originalRelay(jid, message, options);
    };
...
const sendAIRichMessage = async (jid, cfg = {}, options = {}) => {
    ...
    return sock.relayMessage(jid, messageContent, {
    ...options,
    additionalNodes: [
        {
        tag: 'biz',
...
const sendInteractiveWithCallButton = async (jid, cfg = {}, options = {}) => {
    ...
    return {
        ...
        sendAIRichMessage: sendAIRichMessage,
